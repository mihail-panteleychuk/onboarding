...
class PlanSerializer(serializers.ModelSerializer):
    class Meta:
        model = Plan
        fields = ('id', 'name', 'description', 'monthly_price',
                  'amount_products_per_week', "status", "is_trial")
...
class SubscriptionCreateViewSerializer(serializers.Serializer):
    ...
    class Meta:
        fields = ('discount_code', 'plan', 'payment', 'email_subscribed', 'billing_address', 'first_name', 'last_name')
...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Subscription
        fields = ('id', 'plan', 'scheduled_plan', 'active', 'start_date', 'payment_status', "next_payment_date",'expire_date', )
