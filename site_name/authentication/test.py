...
class CustomTokenObtainPairViewTest(APITestCase, URLPatternsTestCase):
    ...
    def setUp(self):
        super(CustomTokenObtainPairViewTest, self).setUp()
    ...
    def test_user_auth_invalid_pass(self):
        ...
        self.assertEquals(resp.data['message']['detail'], 'The email or password you entered is incorrect.')
...
class CustomTokenRefreshViewTest(APITestCase, URLPatternsTestCase):
    ...
    def setUp(self):
        super(CustomTokenRefreshViewTest, self).setUp()
        self.user = baker.make('user.User')
        self.password = '12351994'
        self.user.set_password(self.password)
        self.user.save()
...
class ChangeUserEmailTest(APITestCase, URLPatternsTestCase):
    ...
    def setUp(self):
        super(ChangeUserEmailTest, self).setUp()
    ...
    def test_change_old_email_not_passed(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'Old user email not providen.')


    def test_change_old_email_is_invalid(self):
        data = {
            "email": self.user.email+'123',
            "new_email": self.new_email
        }
        api_request = APIRequestFactory().post("", data = data)
        view = ChangeUserEmail.as_view()
        ...
        self.assertEquals(resp.data['message']['detail'], 'Not found.')

    def test_change_email_new_email_already_exists(self):
        data = {
            "email": self.user.email,
            "new_email": self.existing_email
        }
        api_request = APIRequestFactory().post("", data = data)
        view = ChangeUserEmail.as_view()
        resp = view(api_request)
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'This email already exists.')
    ...
    def test_change_email_new_email_not_providen(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'New user email not providen.')
    ...
    def test_change_email_already_confirmed(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'User email is already verified.')
...
class SendConfirmationEmailTest(APITestCase, URLPatternsTestCase):
    ...
    def setUp(self):
        super(SendConfirmationEmailTest, self).setUp()
    ...
    def test_send_email_success(self):
        ...
        self.assertEquals(resp.status_code, 200)
        self.assertEquals(resp.data, 'Confirmation email was sent')
    ...
    def test_send_email_address_is_invalid(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'Please provide a valid email address')
    ...
    def test_send_email_name_is_invalid(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'Please provide first name, last name and email')
...
class ForgotPasswordViewTest(APITestCase, URLPatternsTestCase):
    ...
    def test_get_incorrect_code(self):
        ...
        self.assertEqual(resp.status_code, 400)
        self.assertEqual(resp.data['message']['detail'], 'The code you entered is incorrect, please try again')
...
class TempEmailGeneratingTest(TestCase):
    ...
    def setUp(self):
        super(TempEmailGeneratingTest, self).setUp()
...
class SocialAccountDeleteTest(APITestCase, URLPatternsTestCase):
    ...
    def setUp(self):
        super(SocialAccountDeleteTest, self).setUp()
        self.email = 'vitalik_t@dataforest.ai'
        self.password = '12351994'
