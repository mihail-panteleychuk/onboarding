...
from .views import (CustomTokenRefreshView, CustomTokenObtainPairView, GoogleTokenView, SendConfirmationEmail,
                    ForgotPasswordView, FacebookTokenView, AppleTokenView, ChangeUserEmail)
