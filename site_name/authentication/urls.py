...
from .views import (CustomTokenRefreshView, CustomTokenObtainPairView, GoogleTokenView, SendConfirmationEmail, ChangeUserEmail,
                    ForgotPasswordView, FacebookTokenView, AppleTokenView)
...
urlpatterns = [
    ...
    # social networks sign-in/sign-up pages
