from payments.utils import sync_user_data, create_stripe_customer, update_customer_billing_info, remove_customer
...
class BillingAddress(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        update_customer_billing_info(self, _type='billing')     # sync customer billing info to stripe
