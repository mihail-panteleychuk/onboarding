...
from site_name.payments.serializers import CardModelSerializer
from site_name.subscription.constants import PaymentStatus
from site_name.subscription.serializers import SubscriptionSerializer
from site_name.user.models import Country, User
from site_name.user.validators import validate_user_password
...
class FullUserInfoSerializer(serializers.ModelSerializer):
    ...
    @staticmethod
    def get_role(obj):
        return {"id": obj.role, "name": dict(User.UserRoleChoices)[obj.role]}
