...
__all__ = (
    'CountrySerializer', 'CountryListSerializer', 'ShortCountrySerializer', 'ChangePasswordSerializer',
    'ChangeEmailSerializer', 'BillingInfoSerializer', 'LanguageSerializer', 'FullBillingInfoSerializer',
    'UserSocialAccountSerializer', 'CompanyDetailsSerializer', 'AccountBillingSerializers', 'SettingsSerializer'
)
...
class AccountBillingSerializers(serializers.ModelSerializer):
    ...
    def to_representation(self, instance, *args, **kwargs):
        data = super(AccountBillingSerializers, self).to_representation(instance, *args, **kwargs)
    ...
    def update(self, instance, validated_data):
        ...
        if 'company' in validated_data:
            ...
            s.is_valid()
            s.save()
        super(AccountBillingSerializers, self).update(instance, validated_data)
        return instance
