...
class TestUser(TestCase):
    ...
    def test_full_name(self):
        test_full_name = f"{self.models.first_name or ''} {self.models.last_name or ''}" if any(
            [self.models.first_name, self.models.last_name]) else None
...
class UserViewSetTest(APITestCase, URLPatternsTestCase):
    ...
    def __check_if_data_is_full_user_info(self, data):
        data_keys = ['id', 'first_name', 'last_name', 'email', 'created',
                     'accounts', 'role', 'email_added', 'created', 'password_created']
...
class ChangeUserEmailViewTest(APITestCase, URLPatternsTestCase):
    ...
    def test_change_email_to_current_email_address(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'],
    ...
    def __check_if_data_is_full_user_info(self, data):
        data_keys = ['id', 'first_name', 'last_name', 'email', 'language', 'billing_info', 'created', 'company',
                     'accounts',
                      'role', 'email_added', 'created', 'password_created']
        self.assertTrue(all([key in data_keys for key in data.keys()]))
