...
class TestUser(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.models), self.models.email)


    def test_full_name(self):
        test_full_name = f"{self.models.first_name or '' } {self.models.last_name or ''}" if any([self.models.first_name, self.models.last_name]) else None
        self.assertEquals(self.models.full_name, test_full_name)
...
class CountryListViewTest(APITestCase, URLPatternsTestCase):
    urlpatterns = [
        path('api/user/', include('user.urls')),
    ]

    def setUp(self):
        super(CountryListViewTest, self).setUp()
    ...
    def test_list_success(self):
        ...
        self.assertIsInstance(resp.json(), list)
        self.assertEquals(len(resp.json()), len(self.country_model))
    ...
    def test_retrieve_success(self):
        ...
        self.assertEquals(resp.data['id'], country_id)
        self.assertEquals(resp.data['name'], self.country_model[0].name)


class UserViewSetTest(APITestCase, URLPatternsTestCase):
    urlpatterns = [
        path('api/user/', include('user.urls')),
    ]
    ...
    def __check_if_data_is_full_user_info(self, data):
        data_keys = ['id', 'first_name', 'last_name', 'email', 'language', 'avatar', 'billing_info', 'created', 'company', 'accounts',
                     'subscription', 'role', 'payment_service_user_id', 'onboarding_finished', 'email_added', 'created', 'password_created']
    ...
    def test_retrieve_success(self):
        ...
        self.assertEquals(resp.status_code, 200)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['id'], str(self.user_model.id))
    ...
    def test_update_user_name(self):
        ...
        new_name = "Vitalik"
        api_request = APIRequestFactory().patch("", data={'first_name': new_name}, format=None, content_type=None)
        detail_view = UserViewSet.as_view({'patch': 'update_user', 'put': 'update_user'})
        force_authenticate(api_request, user=self.user_model)
        resp = detail_view(api_request)

        self.assertEquals(resp.status_code, 200)
        self.assertEquals(resp.data['first_name'], new_name)
    ...
    def test_update_role_invalid(self):
        ...
        new_role = 20
        api_request = APIRequestFactory().patch("", data={'role': new_role}, format=None, content_type=None)
        detail_view = UserViewSet.as_view({'patch': 'update_user', 'put': 'update_user'})
        force_authenticate(api_request, user=self.user_model)
        resp = detail_view(api_request)

        self.assertEquals(resp.status_code, 200)
        self.assertEquals(resp.data['role']['id'], old_role)
        self.assertNotEquals(resp.data['role']['id'], new_role)
    ...
    def test_set_language(self):
        ...
        self.assertIsInstance(resp.data, dict)
        self.assertEqual(resp.data['message']['detail'], "Required field 'language' is not passed.")
    ...
    def test_set_password_success(self):
        ...
        self.assertEquals(resp.status_code, 200)
        self.assertEquals(resp.data['message']['detail'], 'A password has been successfully set!')
        if settings.ONBOARDING_ENABLED:
            self.assertEquals(resp.data['onboarding_finished'], False)
        else:
            self.assertEquals(resp.data['onboarding_finished'], True)
    ...
    def test_set_password_not_active_account(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'User email is not confirmed.')
    ...
    def test_change_password_success(self):
        ...
        self.assertEquals(resp.status_code, 200)
        self.assertEquals(resp.data['message']['detail'], 'Your password has successfully changed!')
    ...
    def test_change_password_incorrect_current_pass(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'Current password is entered incorrectly')


    def test_change_password_the_same_new_pass(self):
        old_password = '12351994'
        self.__update_password_to(old_password)
        new_password = '12351994'
        data = {
            'old_password': old_password,
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertEquals(resp.data['message']['detail'], 'You already have this password')




class ChangeUserEmailViewTest(APITestCase, URLPatternsTestCase):
    urlpatterns = [
        path('api/user/', include('user.urls')),
    ]

    def setUp(self):
        super(ChangeUserEmailViewTest, self).setUp()
    ...
    def test_send_message_to_new_email_success(self):
        ...
        self.assertEquals(resp.status_code, 200)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'], 'Confirmation email was sent')
    ...
    def test_change_email_to_current_email_address(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'], 'You already have this email address. Kindly try another one!')
    ...
    def test_change_email_to_current_email_address(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'], 'This email already exists. Kindly try another one')
    ...
    def test_confirm_code_from_email(self):
        ...
        code_obj = ConfirmCode.objects.filter(expiring_date__gt=now(), new_email__isnull=False, user=self.user).first()
        query = {
            'code': code_obj.code,
        }
    ...
    def test_confirm_code_not_passed(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'],'provide digital code')
    ...
    def test_confirm_code_is_invalid(self):
        ...
        self.assertEquals(resp.status_code, 400)
        self.assertIsInstance(resp.data, dict)
        self.assertEquals(resp.data['message']['detail'],'Email not confirmed. Confirmation code is expired or does not exist.')
