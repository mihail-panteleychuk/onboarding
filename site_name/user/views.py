...
class UserViewSet(viewsets.GenericViewSet, mixins.UpdateModelMixin):
    ...
    def set_password(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response({"message": {"detail": _("A password has been successfully set!")},
                             "onboarding_finished": user.onboarding_finished}, status=status.HTTP_200_OK)
    ...
    def set_language(self, request, *args, **kwargs):
        ...
        if not lang:
            return Response({"message": {"detail": _("Required field 'language' is not passed.")}},
