...
DJANGO_ADMIN_URL = (
    os.environ.get("DJANGO_ADMIN_URL") or "api/admin/"
...
MIDDLEWARE = [
    ...
    # custom middleware for detecting language from user profile
    "core.middleware.LangBasedOnUserSettingsMiddleware",
...
SIMPLE_JWT = {
    ...
    "AUTH_TOKEN_CLASSES": ("core.auth.CustomAccessToken",),
...
AUTHENTICATION_BACKENDS = ["core.auth.CustomModelAuthBackend"]
TEMPLATES = [
    {
...
CELERY_RESULT_BACKEND = os.environ.get("CELERY_RESULT_BACKEND", default="redis://localhost:6379/1")
CELERY_ACCEPT_CONTENT = ["application/json", "json", "pickle"]
...
TRANSLATION_GOOGLE_SHEET_ID = os.environ.get("TRANSLATION_GOOGLE_SHEET_ID")
