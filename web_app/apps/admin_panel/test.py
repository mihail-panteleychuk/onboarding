...
class AdminViewTestStripe(SkipStripeSignalsTestCase, APITestCase, URLPatternsTestCase):
...
class ListOfRolesViewTest(AdminViewTestStripe):
...
class AdminPanelUsersViewSetTest(AdminViewTestStripe):
    def setUp(self):
        super().setUp()
