...
<details><summary><b>Start Project:</b></summary>
    ...
    <p>If you want to run project outside the DockerContainer:</p>
    <ol>
        ...
        <li>Install dependencies</li>
                <ul>
                    <li>make install <b>(for running on servers)</b></li>
                    <li>make install-dev <b>(for local development)</b></li>
                </ul>
        <li>Run the project</li>
            <ul>
                <li>env $(cat <path_to_.env_file>) python manage.py runserver</li>
            </ul>
    </ol>
</details><hr><hr>
...
<hr><hr>
<details><summary><b>Make Comands</b></summary>
    This project has few prepared commands for that should make your life a bit easier.
    <ol>
        <li>make install</li>
            <ul>
                <li>Installing all listed in "./dropship/requirements.txt" dependencies</li>
            </ul>
        <li>make install-dev</li>
            <ul>
                <li>Doing same as `make install` but addding few additional packages for local development like: pre-commit, flake8, isort, etc. These packages are necessary for local auto formatting and keeping code beautiful</li>
            </ul>
        <li>make uninstall-dev</li>
            <ul>
                <li>Removing all packages that were installed by previous command.</li>
            </ul>
        <li>make lint</li>
            <ul>
                <li>Checking whole project for code styling, and outputs problems to terminal</li>
            </ul>
        <li>make format</li>
            <ul>
                <li>Trying to automatically fix discovered problems. You can double check applied changes with git.</li>
            </ul>
    </ol>
</details>
<hr><hr>
<details><summary><b>Pre-commit</b></summary>
    <p>For local development prepared pre-commit module, that handles additional formatting and code style problems.</p>
    <p>To enable it just run <b>make install-dev</b> command.
    After that it will automatically process all files added to commit, and makes refactor changes, so you should double check output and new changes in files.<\p>
    <p><b>It will block commit action until all problems will be solved</b></p>
</details>
<hr><hr>
